...
<script src="../../public/js/personal/personal_create.js"></script>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <form id="form_create_personal" class="needs-validation">
          <div class="form-row">
          ...
          <div class="form-row  ">
            ...
            <span class="border form-row col-md-7 ">
              ...
              <div class="form-group col ">
                <label for="in_select_ano">Función</label>
                <select id="in_select_ano" name="in_select_rol" class="form-control">
